...
$styledSelect.click(function(e){e.stopPropagation();$('div.select-styled.active').not(this).each(function(){$(this).removeClass('active').next('ul.select-options').hide();});$(this).toggleClass('active').next('ul.select-options').toggle();});$listItems.click(function(e){$listItems.show();e.stopPropagation();$styledSelect.text($(this).text()).removeClass('active');$this.val($(this).attr('rel'));$(this).hide();$list.hide();});$(document).click(function(){$styledSelect.removeClass('active');$list.hide();});});};function makeLinkedSelectCustom(element){element.each(function(){var $this=$(this),numberOfOptions=$(this).children('.option').length;$this.addClass('select-hidden');$this.wrap('<div class="select"></div>');$this.after('<div class="select-styled"></div>');var $styledSelect=$this.next('div.select-styled');$styledSelect.text($this.children('.option').eq(0).text());var $list=$('<ul />',{'class':'select-options'});for(var i=0;i<numberOfOptions;i++){var $linkItem=$(document.createElement('li'))
$('<a />',{class:'select-item-link',text:$this.children('.option').eq(i).text(),href:$this.children('.option').eq(i).attr('href')}).appendTo($linkItem);$linkItem.appendTo($list);}
$list.insertAfter($styledSelect);var $listItems=$list.children('li').children('a');$listItems.eq(0).hide();$styledSelect.click(function(e){e.stopPropagation();$('div.select-styled.active').not(this).each(function(){$(this).removeClass('active').next('ul.select-options').hide();});$(this).toggleClass('active').next('ul.select-options').toggle();});$listItems.click(function(e){$listItems.show();e.preventDefault();e.stopPropagation();$styledSelect.text($(this).text()).removeClass('active');$this.attr('href',(($(this).attr('href'))));$(location).attr('href',$this.attr('href'));$(this).hide();$list.hide();});$(document).click(function(){$styledSelect.removeClass('active');$list.hide();});});}
if($('#solutions-for').length){makeLinkedSelectCustom($('#solutions-for'));}
if($('.form__fieldset-select').length&&!iOS){$('.form__fieldset-select').each(function(){makeSelectCustom($(this));})}
...
body.on('click','.form__fieldset-label-hint-btn',function(evt){evt.preventDefault();$(this).siblings('.form__fieldset-hint').addClass('form__fieldset-hint--open');body.on('click',hideHint);});body.on('click','.form__fieldset-hint',function(){$(this).removeClass('form__fieldset-hint--open');});body.on('click','.form__fieldset-btn-file',function(){$(this).siblings('.form__fieldset-input--file').click();});body.on('change','.form__fieldset-input--file',function(){var $fileName=$(this).prop('files')[0].name;$(this).siblings('.form__fieldset-input--file-path').val($fileName);});$('.open-dialog').click(function(){$('.popup').show();});$('.popup__close-btn').click(function(){$('.popup').hide();});$('.popup__btn').click(function(){$('.popup').hide();});