...
body.on('click','.main-nav__toggle',function(){$(this).toggleClass('main-nav__toggle--opened');$('.main-nav').toggleClass('main-nav--opened');$('.header__contacts').toggleClass('header__contacts--menu-active');$('.header').toggleClass('header--active');});body.on('click','.main-nav__list-item--hovered',function(){$(this).children('.main-nav__list-link').toggleClass('main-nav__list-link--active');});$('.main-nav__list-item--hovered').swipe({tap:function(event,target){$(this).children('.main-nav__list-link').toggleClass('main-nav__list-link--active');}});$(".testimonials__slides-list-wrapper").swipe({swipeLeft:function(event,direction,distance,duration,fingerCount,fingerData){next();},swipeRight:function(event,direction,distance,duration,fingerCount,fingerData){prev();},allowPageScroll:"vertical",threshold:35});function toggleFaq(isAccordion){body.on('click','.faqs__item-header',function(){$target=$(this);$item=$target.closest('.faqs__item');if(isAccordion){if($item.hasClass('faqs__item--active')){$item.removeClass('faqs__item--active');return;}
...
$('.get-renovation__btn').click(function(){$('.popup').show();});$('.get-renovation__btn').keydown(function(e){if(e.which===ENTER_KEYCODE){$('.popup').show();}});$('.popup__close-btn').click(function(){$('.popup').hide();});$(document).keydown(function(e){if(e.which===ESC_KEYCODE){$('.popup').hide();}});$('.popup__btn').click(function(){$('.popup').hide();});$('.popup__btn').keydown(function(e){if(e.which===ENTER_KEYCODE){$('.popup').hide();}});