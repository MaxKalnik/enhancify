...
if($('.form__fieldset-select').length){$('.form__fieldset-select').each(function(){makeSelectCustom($(this));})}
...
body.on('click','.form__fieldset-label-hint-btn',function(evt){evt.preventDefault();$(this).find('.form__fieldset-hint').addClass('form__fieldset-hint--open');body.on('click',hideHint);});body.on('click','.form__fieldset-hint',function(){evt.preventDefault();$(this).removeClass('form__fieldset-hint--open');});body.on('click','.form__fieldset-btn-file',function(){$('.form__fieldset-input--file').click();});$('.open-dialog').click(function(){$('.popup').show();});$('.popup__close-btn').click(function(){$('.popup').hide();});$('.popup__btn').click(function(){$('.popup').hide();});var iOS=/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream;var iOS2=!!navigator.platform&&/iPad|iPhone|iPod/.test(navigator.platform);if(iOS){console.log('ios v1')};if(iOS2){console.log('ios v2')}